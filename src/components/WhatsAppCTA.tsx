  ...
  return (
    <>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className={`wa-sticky ${visible ? "wa-sticky-visible" : ""}`}
        aria-label="Open NaijaMarket Intel on WhatsApp"
        title="Check prices on WhatsApp"
      >
        <WhatsAppIcon size={26} />
        <span className="wa-sticky-label">Price Check</span>
      </a>
    </>
  );
}
