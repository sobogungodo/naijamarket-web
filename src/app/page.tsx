...
const FEATURES = [
  { icon: "�x�", title: "Real-Time Prices", desc: "Live GPS-verified prices from 282 markets across 36 states + FCT. Updated 3� daily by on-ground traders.", accent: "#00C853" },
  { icon: "�x`", title: "Bloomberg-Grade Analytics", desc: "Inflation tracking, heatmaps, arbitrage scanner, and market screeners at startup prices.", accent: "#FFB300" },
  { icon: "�x:�️", title: "Fraud-Proof Verification", desc: "GPS validation, community consensus, and ML anomaly detection. 95%+ confidence.", accent: "#00B0FF" },
  { icon: "�x", title: "Smart Price Alerts", desc: "Set thresholds. Get WhatsApp notifications when prices cross your targets.", accent: "#FF5252" },
  { icon: "�x�", title: "Inflation Tracker", desc: "NaijaMarket Food Price Index vs NBS. Real inflation, not months later.", accent: "#E040FB" },
  { icon: "�xR�", title: "Regional Comparison", desc: "Compare prices across states. Spot arbitrage opportunities before competitors.", accent: "#26A69A" },
];
...
function WADemo() {
  ...
  const botReply = `�x�a Rice (50kg) - Lagos Markets

�x� Mile 12: ��82,450 (+0.34%)
�x� Ojo Market: ��81,200 (-0.15%)
�x� Mushin: ��83,100 (+0.52%)

�x` Avg: ��82,250 | �x Updated 2h ago
      ...
      <div className={`nm-hero-inner${visible ? " nm-visible" : ""}`}>
        <div className="nm-hero-copy">
          ...
          <div className="nm-hero-ctas">
            ...
            >
              �x� Check Prices on WhatsApp <span className="nm-arrow">� </span>
            </a>
...
function HowItWorksSection() {
  const { ref, visible } = useInView();
  const steps = [
    { num: "01", icon: "�x�", title: "Search Any Commodity", desc: "Type a commodity, market, or state. Get instant verified prices from our trader network." },
    { num: "02", icon: "�x`", title: "Analyze Market Trends", desc: "View price history, inflation trends, regional comparisons, and arbitrage opportunities." },
    { num: "03", icon: "�a�", title: "Set Alerts & Act", desc: "Create custom price alerts. Get WhatsApp notifications. Make data-driven decisions." },
  ];
            ...
            >
              ...
              <ul className="nm-price-features">
                {tier.ft.map((feature, j) => (
                  <li key={j}>
                    <span className="nm-check">�S</span>
                    {feature}
                  </li>
                ))}
              </ul>
  ...
  return (
    <footer className="nm-footer">
      ...
      <div className="nm-footer-bottom">
        ...
        <span>�x!��x!� Built for Nigeria · �x!��x!� Powered from Finland</span>
      </div>
    </footer>
  );
}
